...
func GetHeartbeats(queryParameters map[string]string, heartbeatsFetcher heartbeat.HeartbeatsFetcher) (status int, result *cloudwatchlogs.GetQueryResultsOutput, err error) {
...
func HeartbeatsHandler(heartbeatsFetcher heartbeat.HeartbeatsFetcher) gin.HandlerFunc {
